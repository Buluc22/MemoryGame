...
namespace MemoryGame
{
    public partial class Form1 : Form
    {
        ...
        Panel firstCoverSelecion, secondCoverSelecion;
        ...
        private void pnlCover_Click(object sender, EventArgs e)
        {
            ...
            if (firstSelection == null)
            {
                ...
                firstCoverSelecion = clickedPanel;
                return;
            }
            ...
            if (secondSelection == null)
            {
                ...
                secondCoverSelecion = clickedPanel;
            }
        ...
        private void CleanSelections(bool match)
        {
            if (!match)
            {
                firstCoverSelecion.Visible = true;
                secondCoverSelecion.Visible = true;
            }

            firstCoverSelecion = null;
            secondCoverSelecion = null;
            firstSelection = null;
